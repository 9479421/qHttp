...
public class qHttp {
    ...
    public void setCookies(String cookieAll) {
        httpHeaders.put("Cookie", cookieAll);

        String cookieArr[] = cookieAll.split(";");
    ...
    public qHttpResponse post() throws IOException {
//        httpURLConnection = (HttpURLConnection) url.openConnection();
    ...
    public qHttpResponse post(String params) throws IOException {
//        httpURLConnection = (HttpURLConnection) url.openConnection();
        httpURLConnection.setDoInput(true);
        httpURLConnection.setDoOutput(true);
    ...
    public qHttpResponse get() throws IOException {
//        httpURLConnection = (HttpURLConnection) url.openConnection();
        return send("GET", "");
    ...
    private qHttpResponse send(String method, String params) throws IOException {
        //自动Auto协议头
//        setHeader("Referer", url.toString() + params);
        ...
        if (isAutoCookie) {
            ...
            while (iterHeader.hasNext()) {
                ...
                if (key != null && key.equals("Location")) {
                    qHttpResponse.setLocation(httpURLConnection.getHeaderField(key));
                }
            }
            String cookie = "";
        ...
        qHttpResponse.setCode(responseCode);
        if (responseCode == 200) {
            //置入Base64
/*            if (allowBase64) {
           ...
           /* try {
            ...
            qHttpResponse.setBytes(bytes);
            qHttpResponse.setBody(new String(bytes));
